...
signal on_get_finished(in_success: bool, in_data: Variant)
signal on_set_finished(in_success: bool)
...
func _on_js_get_then(args):
	...
	on_get_finished.emit(true, data)
