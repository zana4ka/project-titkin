...
func play(p_bank_label: String, p_track_name: String, in_offset: float = 0.0, p_crossfade_time: float = 5.0, p_auto_loop: bool = false) -> bool:
	if not has_loaded:
	...
	player.start_stems(stems, in_offset, p_crossfade_time)
